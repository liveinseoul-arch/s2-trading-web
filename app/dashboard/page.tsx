  ...
  return (
    <>
      ...
      <p className="mb-4 text-xs text-muted">
        기준자본 1억 · 비용 적용 모델(매수 0.015% / 매도 0.215% = 증권거래세 0.05%+농특세 0.15%) · 분할매도(33/33/33) 120일선 아래 +3/+5/+7 · 위 +3/+6.5/+10·−7% 추가매수·18%/9% 사이징·레버 1.2·낙주필터(ret5&lt;−30)·3주 기간 손절·시초 매도·추가매수일 매도 보류·broker 충돌 시 3차 매수 skip 적용. 실거래 슬리피지 추가 있을 수 있음. 자세히는 규칙 화면 참고.
      </p>
