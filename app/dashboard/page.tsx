  ...
  return (
    <>
      ...
      <p className="mb-4 text-xs text-muted">
        기준자본 1억 · 비용 적용 모델(매수 0.015% / 매도 0.265%) · +2/+6/+14 분할매도·3주 기간 손절·시초 매도·추가매수일 매도 보류·broker 충돌 시 3차 매수 skip 적용. 실거래 슬리피지 추가 있을 수 있음.
        11.8년(2014-08~2026-06) 전체 검증 — CAGR 11.2% · MDD −11.3% · Calmar 1.00. 자세히는 규칙 화면 참고.
      </p>
