        ...
        <>
                ...
                <table className="w-full text-sm tnum">
                  <thead className="text-xs text-muted">
                    <tr className="border-b border-[var(--color-borderc)] text-right">
                      ...
                      <th>종가</th>
                      <th title="52H = 52주 최고가 대비 현재가 위치. −30% 초과 하락이면 매수 대상 제외(행 흐리게)">52H</th>
          ...
          <div className="space-y-1.5 text-xs text-muted">
            ...
            <p>
              ...
              매도 신호가 아니라 <b>신규 추격매수에 신중</b>하라는 보조 표시입니다(검증상 클라이맥스 직후 매수는 연환산 기대수익이 약 5%로, 그 외 매수 약 30%의 <b>6분의 1</b> 수준).
            </p>
          </div>
          </div>
