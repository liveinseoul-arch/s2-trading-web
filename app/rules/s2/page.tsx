...
const RULES: { t: string; d: string }[] = [
  ...
  { t: "분할매도", d: "평단 +3% / +5% / +7%에서 10% / 10% / 80% 매도. 일봉 백테스트만 보면 +2/+6/+14 가 더 높지만, 그 우위는 '터치=체결' 가정에 의존한다 — 분봉 실측상 +14% 3차완결이 절반만 실현(고가 스침≠지정가 체결)돼 두 규칙이 사실상 동률. +7% 는 확실히 체결돼 실현 가능성이 높아 채택." },
    ...
    <>
      ...
      <Section title="검증 성과 (정직 공개)">
        <ul className="flex flex-col gap-2 text-sm">
          <li><b>11.9년(2014-08~2026-07, 비용 0.215% 적용 · 현재 운용값 = 3주 기간 손절·+3/+5/+7 분할매도·−7% 추가매수·18%/9% 사이징·시초 매도·추가매수일 매도 보류·broker 충돌 시 3차 매수 skip)</b>:
            CAGR <b className="text-accent">11.15%</b> · MDD <b className="text-accent">−12.0%</b> ·
            Calmar <b className="text-accent">0.93</b> · 승률 84.8% <span className="text-muted">(2026-07-18 재측정)</span>.</li>
