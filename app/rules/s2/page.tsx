    ...
    <>
      ...
      <Section title="검증 성과 (정직 공개)">
        <ul className="flex flex-col gap-2 text-sm">
          <li><b>11.8년(2014-08~2026-06, 현재 유니버스, 비용 적용 0.28% 라운드트립 · 3주 기간 손절·+2/+6/+14 분할매도·시초 매도·추가매수일 매도 보류·broker 충돌 시 3차 매수 skip 적용)</b>:
            CAGR <b className="text-accent">~11.2%</b> · MDD <b className="text-accent">~−11.3%</b> ·
            Calmar <b className="text-accent">~1.00</b> · 승률 ~90%.</li>
          <li className="text-muted">분할매도 +3/+5/+7 (이전): CAGR 7.6% · Calmar 0.69. +2/+6/+14 가 +3.6%p CAGR 우위.</li>
