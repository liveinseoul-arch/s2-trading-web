...
import { S2_SUMMARY, S2_CONFIG_LINE } from "@/lib/s2rules";
...
const STEPS = [
  {
    ...
    d: `검증된 S2 룰(11.8년 백테스트, 비용 적용, ${S2_CONFIG_LINE})을 시세에 적용해 모델 포트폴리오를 추적합니다. 직장에서 일하는 동안 시스템이 대신 봅니다.`,
  },
  {
    n: "2",
    t: "15:10 — 동시호가 직전 알림",
...
const FAQ = [
  ...
  {
    q: "어떤 매매 시스템인가요?",
    a: `S2 — ${S2_SUMMARY} 11.8년(2014-08~) 백테스트로 검증 완료입니다 — 2018·2020 큰 폭락 포함, 시초 매도·추가매수일 매도 보류 보수적 가정(규칙 화면에 상세 공개).`,
  },
  {
