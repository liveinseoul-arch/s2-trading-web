...
const STEPS = [
  {
    ...
    d: "검증된 S2 룰(11.8년 백테스트 Calmar ~1.13, 비용 적용, +2/+6/+14 분할매도·−7% 추가매수·18%/9% 사이징·3주 기간 손절·시초 매도·추가매수일 매도 보류·broker 충돌 시 3차 매수 skip)을 시세에 적용해 모델 포트폴리오를 추적합니다. 직장에서 일하는 동안 시스템이 대신 봅니다.",
  },
  {
    n: "2",
    t: "15:10 — 동시호가 직전 알림",
...
const FAQ = [
  ...
  {
    q: "어떤 매매 시스템인가요?",
    a: "S2(주도주 급락 눌림목 매매) — 일정 거래대금 이상 종목이 20일선 −20%(Envelope)를 이탈할 때 동시호가 지정가 진입, 분할매도 +3/+5/+7%, 거래대금 리셋·신저가 손절. 11.8년(2014-08~) 백테스트로 검증 완료입니다 — 2018·2020 큰 폭락 포함, 시초 매도·추가매수일 매도 보류 보수적 가정(규칙 화면에 상세 공개).",
  },
  {
