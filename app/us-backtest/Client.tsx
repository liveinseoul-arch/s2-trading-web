...
const YEARLY: { year: number; ret: number; mdd: number; iret: number; imdd: number; n: number; win: number; avg: number }[] = [
  { year: 2016, ret: -2.5, mdd: -2.8, iret: 9.5, imdd: -8.8, n: 5, win: 20, avg: -5.9 },
  { year: 2017, ret: 21.9, mdd: -8.3, iret: 19.4, imdd: -2.3, n: 22, win: 45, avg: 7.0 },
  { year: 2018, ret: 9.1, mdd: -7.3, iret: -7.0, imdd: -17.5, n: 27, win: 48, avg: 7.9 },
  { year: 2019, ret: 5.7, mdd: -3.0, iret: 30.3, imdd: -6.6, n: 14, win: 64, avg: 2.2 },
  { year: 2020, ret: 9.9, mdd: -6.9, iret: 14.3, imdd: -31.8, n: 34, win: 38, avg: 2.1 },
  { year: 2021, ret: -5.9, mdd: -16.1, iret: 28.7, imdd: -3.9, n: 43, win: 26, avg: 0.9 },
  ...
  { year: 2025, ret: 42.7, mdd: -9.5, iret: 16.1, imdd: -17.0, n: 33, win: 36, avg: 1.7 },
  { year: 2026, ret: 34.0, mdd: -9.1, iret: 6.1, imdd: -8.6, n: 32, win: 56, avg: 25.9 },
];
...
const MONTHLY: Record<string, Record<number, number>> = {
  ...
  "2017": { 1: 1.4, 2: -0.3, 3: 2.1, 4: 1.5, 5: 3.3, 6: -6.4, 7: 3.9, 8: 2.6, 9: 6.4, 10: 2.7, 11: 10.3, 12: -6.3 },
  "2018": { 1: 9.6, 2: -2.3, 3: -3.3, 4: -0.5, 5: 2.3, 6: 1.1, 7: -0.4, 8: 6.3, 9: 2.3, 10: -5.4, 11: 0.0, 12: 0.0 },
  "2019": { 1: 0.1, 2: 2.0, 3: 0.4, 4: -1.1, 5: -0.2, 6: 1.6, 7: 3.7, 8: -0.9, 9: -1.2, 10: 0.1, 11: -0.6, 12: 1.7 },
  "2020": { 1: 0.4, 2: -3.1, 3: -0.6, 4: 0.4, 5: 0.3, 6: 1.2, 7: 6.5, 8: 3.3, 9: -4.0, 10: 0.3, 11: 1.1, 12: 4.2 },
  "2021": { 1: 7.0, 2: -2.5, 3: -2.5, 4: -0.3, 5: -1.1, 6: 0.4, 7: -2.9, 8: 2.1, 9: -0.6, 10: 2.2, 11: -2.4, 12: -4.7 },
  ...
  "2025": { 1: -0.1, 2: -0.8, 3: -0.3, 4: -0.7, 5: -0.7, 6: 2.1, 7: 4.5, 8: 6.7, 9: 9.1, 10: 14.6, 11: -3.0, 12: 6.1 },
  "2026": { 1: 14.4, 2: 7.8, 3: -0.7, 4: 4.9, 5: 6.5, 6: -2.0 },
};
