...
#   ★★[2026-09-18 해달별님 결정 「B」] ★「월 소진 ₩20,000 초과면 flash」를
#     ★코드가 아니라 ★AI Studio 캡을 ₩20,000 으로 낮춰 구현한다.
#     ⚠️★Gemini API 는 ★월 소진액을 ★안 알려 준다 — ★토큰 원장은 ★추정이고
#       ★같은 프로젝트(GameProgramming)를 ★다른 용도가 쓰면 ★과소 집계된다.
#       ★그래서 ★캡이 유일한 정확한 자다 — ★도달하면 429 → 아래 폴백.
